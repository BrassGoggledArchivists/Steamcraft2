...
public class SC2AccessTransformer extends AccessTransformer {
    private static SC2AccessTransformer instance;
    private static List mapFiles = new LinkedList();
    public SC2AccessTransformer() throws IOException {
            super();
            instance = this;
            // add your access transformers here!
            mapFiles.add("steamcraft_at.cfg");
